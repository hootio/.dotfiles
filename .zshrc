...
odmain() {
  ...
  dev connect -t www_fbsource_configerator -y "$1" -- sh -c 'sudo ondemand-idle-checks disable; TERM=xterm-256color SHELL=/bin/zsh exec tmux new-session -A -s hooti-od'
  stty sane
}
